...
// // Handles switching between login and register forms with beautiful transitions
...
//         <div className="absolute -top-10 -left-10 w-96 h-96 bg-gradient-to-r from-blue-200 to-purple-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob"></div>
//         <div className="absolute top-32 -right-10 w-96 h-96 bg-gradient-to-r from-purple-200 to-pink-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-2000"></div>
//         <div className="absolute -bottom-8 left-32 w-96 h-96 bg-gradient-to-r from-pink-200 to-blue-200 rounded-full mix-blend-multiply filter blur-xl opacity-70 animate-blob animation-delay-4000"></div>
//       </div>
...
//           <div className="inline-flex items-center justify-center w-20 h-20 bg-gradient-to-r from-blue-500 via-purple-500 to-pink-500 rounded-3xl shadow-lg mb-4">
...
//               isLoginMode ? 'transform translate-x-0' : 'transform -translate-x-full'
//             }`}
//           >
//             {isLoginMode && (
//               <LoginForm onToggleToRegister={toggleAuthMode} />
//             )}
//           </div>
...
//           >
//             {!isLoginMode && (
//               <RegisterForm onToggleToLogin={toggleAuthMode} />
//             )}
//           </div>
//         </div>
...
//               Create, edit, and organize your notes with blazing speed
//             </p>
//           </div>
...
//             </h3>
//             <p className="text-sm text-gray-600">
//               Your notes are encrypted and secure with advanced authentication
//             </p>
//           </div>
...
//             </h3>
//             <p className="text-sm text-gray-600">
//               Clean, modern interface that makes note-taking a joy
//             </p>
//           </div>
//         </div>
